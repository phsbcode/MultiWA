...
- Conversation message reads, single-message detail and local message deletion verify organization ownership before service execution. Message ownership also requires the stored message profile to match its conversation profile; conversation cursors belong to the selected conversation.
